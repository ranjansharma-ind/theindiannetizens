...
const Navbar = () => {
  ...
  //   const defaultTextColor = "text-black-300";
  ...
  //     <a
  //       href={href}
  //       className={`group relative overflow-hidden h-9 flex items-center ${textSizeClass}`}
  //     >
  //       <div className="flex flex-col transition-transform duration-400 ease-out transform group-hover:-translate-y-1/3">
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            <span className="text-saffron">The</span>Indian
            <span className="font-light">Netizens</span>
          </motion.div>
